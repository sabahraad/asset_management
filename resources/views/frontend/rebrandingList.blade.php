    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Rebranding list</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item">Dashboard</li>
                        <li class="breadcrumb-item active">Rebranding List</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td >
                                    <button class="btn btn-primary edit-employee" data-bs-toggle="modal" data-bs-target="#edit_employee" data-id="1">
                                        <i class="fa-solid fa-pencil m-r-5"></i> Rebranding
                                    </button>
                                </td>
                            </tr>
                            <tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Rebranding Information</h5>
